...
% Herculog previously used the built-in SWI-Prolog implementation, but this broke with SWI-Prolog 9.2.3, because the internal predicates were changed.
% SWI-Prolog writes in February 2024: "If you want to hack around, simply call toplevel_variables:toplevel_var/2. Don’t blame anyone if it stops working without notice though as it is a private API."
...
% This jupyter_variable_bindings module is now used for both SWI-Prolog and SICStus Prolog.
